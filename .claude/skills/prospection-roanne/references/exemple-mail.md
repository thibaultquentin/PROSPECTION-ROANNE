# Exemple de mail conforme (calibrage de ton)

Cet exemple sert uniquement de référence de structure, de longueur et de registre. Ne jamais réutiliser son contenu tel quel — chaque mail doit être réécrit entièrement pour l'entreprise ciblée, à partir des informations réellement trouvées à son sujet.

Le mail part en HTML : ci-dessous, le lien vers la maquette est représenté en syntaxe Markdown `[texte](url)` pour montrer qu'il doit être cliquable — dans le vrai mail c'est une balise `<a href="...">`, et le texte visible ne montre jamais l'URL.

---

**Sujet :** Lassaigne Menuiserie - Optimisation de site internet (Maquette créée)

Bonjour David,

Thibault Quentin. Je conçois des sites sur mesure pour des artisans et commerces du Roannais, et votre site a retenu mon attention.

Une chose m'a marqué : vous êtes certifiés RGE Qualibat, mais ça n'apparaît nulle part sur votre site — pourtant c'est ce qui ouvre droit à MaPrimeRénov' et à la TVA à 5,5 %, et beaucoup de gens vérifient ça avant de choisir un artisan. Et avec la fin de MaPrimeRénov' sur les fenêtres annoncée au 1er septembre, un site qui chiffre tout de suite le reste à charge peut vraiment faire pencher la balance.
...
## Ce qui fait fonctionner ce mail — à reproduire

- **Ouverture sobre et minimale** : nom, activité en une phrase, "votre site a retenu mon attention". Pas de récit sur comment on est tombé dessus, pas d'ancrage local appuyé.
- **Une observation resserrée**, en prose, jamais en liste — un manque concret, avec une urgence ou un enjeu si possible, mais sans étirer sur plusieurs phrases.
- **Une seule phrase** pour annoncer et décrire la maquette, sans lister ses fonctionnalités une à une.
